...
- **出発地・帰着地(事業所)** — 設定で事業所を登録しておくと、訪問順の画面で出発地・帰着地として選べ、地図を開くルートに含まれます。
- **履歴から選ぶ(8週間)** — 一覧の「履歴から選ぶ」や「先週の◯曜日と同じ」から、過去の訪問先と順番をすぐに呼び出せます。履歴は8週間で自動的に削除され、設定から「履歴をすべて消す」こともできます。
- **訪問済みと時刻・コピー** — 地図のカードで訪問先を「済」にすると時刻が記録され、履歴の画面で確認・コピーできます。
...
- [ ] 電話リンクで電話アプリが開く
- [ ] 事業所を登録してから地図を開くと、ルート・URLに事業所が出発地・帰着地として入っている
- [ ] 一覧の「先週の◯曜日と同じ」で、前回と同じ訪問先・順番がすぐに選べる
- [ ] 地図のカードで「済」にすると時刻が記録され、履歴の画面で確認できる
- [ ] 8週間より古い履歴が自動で消えている(設定の「履歴をすべて消す」でもすぐ消せる)
